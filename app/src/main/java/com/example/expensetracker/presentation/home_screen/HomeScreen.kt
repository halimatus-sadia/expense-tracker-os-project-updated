...
fun HomeScreen(
    ...
    BottomSheetScaffold(
        ...
        Column(
            ...
            AnimatedVisibility(visible = currentTabButton == com.example.expensetracker.presentation.home_screen.TabButton.TODAY) {
            ...
            // monthly expenses
            AnimatedVisibility(visible = currentTabButton == com.example.expensetracker.presentation.home_screen.TabButton.MONTH) {
